 ...
 * 작성자는 활성 회원이면 type=MEMBER + id(문자열), 익명/탈퇴면 type=ANONYMOUS + id=null + "익명의 이웃".
...
public record ReportResponse(
    ...
    public static ReportResponse of(ReportData data, LocationSummary location, AuthorInfo author,
                                    long thanksCount, boolean isThanked, List<String> imageUrls) {
        Author authorDto = author != null
                ...
                : new Author(ActorType.ANONYMOUS, null, "익명의 이웃", null);
