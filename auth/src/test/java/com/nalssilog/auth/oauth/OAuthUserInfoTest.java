...
class OAuthUserInfoTest {
    ...
    @Test
    void appleOidcClaimsBecomeSocialIdentity() {
        OAuthUserInfo userInfo = OAuthUserInfo.of("apple", Map.of(
                "sub", "apple-subject",
                EMAIL_KEY, USER_EMAIL
        ));
    ...
    @Test
    void appleUsesTheNameFromTheFirstFormPostAuthorization() {
        ...
        assertThat(userInfo.socialName()).isEqualTo("Gil-dong Hong");
        assertThat(userInfo.email()).isEqualTo(USER_EMAIL);
    }
}
