    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/admin/members/*/role").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/admin/members/role-changes").hasRole("ADMIN")
                        .requestMatchers("/api/admin/**").hasAnyRole("MODERATOR", "ADMIN")
                        .requestMatchers("/api/report-blocks", "/api/report-blocks/**").authenticated()
